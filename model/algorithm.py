...
def content_based_filtering(restoran_df, nama):
    ...
    product_id = restoran_df[restoran_df["Name"] == nama]['Restaurant_ID'].values[0]
    ...
    for item in sorted_scores:
        recommedation.append(restoran_df[restoran_df['Restaurant_ID'] == sorted_scores[j][0]]['Name'].values[0])
        j += 1
